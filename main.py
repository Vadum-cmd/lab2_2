...
def find_closest_locations(current_user_location: str, location_title_dict: dict) -> np.array:
    """
...
def generate_html(location, geocode, latitude: float=49.817545, longitude: float=24.023932, html_path="map.html"):
    ...
    """
    page_map = folium.Map(titles="OpenStreetMap", location=[latitude, longitude], zoom_start=10)
    ...
    user_location_featuregroup.add_child(folium.Marker(
        ...
        popup=folium.Popup(folium.Html("Your Location"), min_width=100, max_width=100),
